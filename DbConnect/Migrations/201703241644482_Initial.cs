    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Patient", t => t.doctorId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Prescription", "FK_Prescription_Patient_doctorId");
            DropForeignKey("dbo.Event", "FK_Event_Patient_patientId");
            DropForeignKey("dbo.Event", "FK_Event_Patient_doctorId");
            DropForeignKey("dbo.Appointment", "FK_Appointment_Patient_patientId");
            DropForeignKey("dbo.Appointment", "FK_Appointment_Patient_doctorId");
