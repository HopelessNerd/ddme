            ...
            <div class="container">
                ...
                <div class="login-form-grids">
                    <form runat="server" id="Frm1">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredUserName" ControlToValidate="txtUserName" runat="server" ErrorMessage="Required Field" ForeColor="Red"></asp:RequiredFieldValidator>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredPassword" ControlToValidate="txtPassword" runat="server" ErrorMessage="Required Field" ForeColor="Red"></asp:RequiredFieldValidator>
                        <div class="clearfix"></div>
                        <div class="forgot">
