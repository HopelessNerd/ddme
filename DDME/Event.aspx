            ...
            <div class="container">
                ...
                <div class="login-form-grids">
                    ...
                    <form name="Frm1" runat="server">
                        ...
                        <input clientidmode="Static" runat="server" class="date" id="txtstart" type="text" value="Appointment date" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Appointment date';}" required="">

                        <input clientidmode="Static" runat="server" class="date" id="txtend" type="text" value="Appointment date" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Appointment date';}" required="">
